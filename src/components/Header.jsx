...
const NavItemInfo=[
  ...
  {name:"Pages",type:"dropdown",
      items:['Papers','Reasearch','Contact Us']},
...
return (
  ...
  <span className='cursor-pointer text-blue-500 absolute transition-all duration-500 font-extrabold right-0 top-0 group-hover:right-[90%] opacity-0 group-hover:opacity-100 '>
    /
    </span>
    </>
    ):(
      ...
      <div className={`${
          ...
          {item.items.map((page,index) =>(
              ...
              <a  
              key={index} href='/' className='hover:bg-dark-hard hover:text-white px-4 py-2 text-white lg:text-dark-soft'>
                {page}
              </a>
